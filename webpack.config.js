...
const config = {
	// Entry of pug files only. Don't put any entry CSS or JS files.
	entry: {
		index: './src/pug/index.pug',
		'index-rtl': './src/pug/index-rtl.pug',
		about: './src/pug/about.pug',
		'about-rtl': './src/pug/about-rtl.pug',
		cart: './src/pug/cart.pug',
		'cart-rtl': './src/pug/cart-rtl.pug',
		'single-post': './src/pug/single-post.pug',
		'single-post-rtl': './src/pug/single-post-rtl.pug',
		404: './src/pug/404.pug',
		'404-rtl': './src/pug/404-rtl.pug',
	},
	output: {
